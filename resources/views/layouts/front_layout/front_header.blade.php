		...
		<div id="welcomeLine" class="row">
			...
			<div class="span6">
				<div class="pull-right">
					<a href="product_summary.html"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i>
					[ <span class="totalCartItems">{{ totalCartItems() }}</span> ] Items in your cart </span> </a>
				</div>
			</div>
		</div>
		<!-- Navbar ================================================== -->
		  ...
		  <div class="navbar">
		    <div class="navbar-inner">
		      <div class="container">
		        ...
		        <a class="brand" href="{{ url('/') }}">Peca Punker</a>
