...
<div class="span9">
    <ul class="breadcrumb">
        ...
        <li class="active">{{ $productDetails['product_name'] }} - Details</li>
    </ul>
    <div class="row">
                ...
                <div class="control-group">
                    ...
                    <h4 class="getAttrPrice">
                        @if($discounted_price>0)
                            <del>EUR {{ $productDetails['product_price'] }}</del>&nbsp;
                            <font color="red">EUR {{ $discounted_price }}</font>
                        @else
                            EUR {{ $productDetails['product_price'] }}
                        @endif
                    </h4>
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="listView">
                            ...
                            <div class="row">
                                <div class="span2">
                                    <?php $product_image_path = 'images/product_images/small/'.$related['main_image'] ?>
                                    @if (!empty($related['main_image']) && file_exists($product_image_path))
                                        <img style="width: 150px;" src="{{ asset('images/product_images/small/'.$related['main_image']) }}" alt="">
                                    @else
                                ...
                                <div class="span4">
                                    ...
                                    <hr class="soft"/>
                                    <h5>Code: {{ $related['product_code'] }}</h5>
                                    <p>
                                        {{ $related['description'] }}.
                                    </p>
                                    <a class="btn btn-small pull-right" href="{{ url('product/'.$related['id']) }}">View Details</a>
                                    <br class="clr"/>
                                </div>
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        <h3> EUR {{ $related['product_price'] }}</h3>
                                        <label class="checkbox">
                                            <input type="checkbox">  Adds product to compair
                                        </label><br/>
                                        <div class="btn-group">
                                            <a href="{{ url('product/'.$related['id']) }}" class="btn btn-large btn-primary"> Add to <i class=" icon-shopping-cart"></i></a>
                                            <a href="{{ url('product/'.$related['id']) }}" class="btn btn-large"><i class="icon-zoom-in"></i></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center"><a class="btn" href="{{ url('product/'.$related['id']) }}"> <i class="icon-zoom-in"></i></a> 
                                                <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">
                                                    EUR {{ $related['product_price'] }}</a></h4>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
